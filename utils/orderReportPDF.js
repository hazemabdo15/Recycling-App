  ...
  <html>
    ...
    <body>
      <div class="header">
        ...
        <div class="subtitle">${t ? t('recyclingHistory.pdfReport.subtitle') : 'Generated by Recycling App'}</div>
      </div>
      <div class="section">
      ...
      <div class="footer">
        ${t ? t('recyclingHistory.pdfReport.footer') : 'Recycling App © 2025 | Contact: support@recyclingapp.com'}
      </div>
    </body>
  </html>
  `;

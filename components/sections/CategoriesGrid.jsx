...
const CategoriesGrid = ({ searchText = '', onCategoryPress, onFilteredCountChange, showItemsMode = false }) => {
    ...
    }, [filteredCategories.length, filteredItems.length, onFilteredCountChange, showItemsMode]);
    ...
    return (
        <FadeInView delay={0}>
            <ScrollView
                ...
                contentContainerStyle={showItemsMode ? styles.itemsScrollContainer : styles.scrollContainer}
            >
                {showItemsMode ? (

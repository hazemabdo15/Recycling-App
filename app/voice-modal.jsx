...
const MODAL_HEIGHT = SCREEN_HEIGHT * 0.85; // Further reduced for very small screens like 360x664
...
export default function VoiceModal() {
  ...
  const recordButtonSize = isVerySmallScreen
    ? 56
    : isSmallScreen
    ? 60
    : isMediumScreen
    ? 76
    : 84;
  const recordButtonMargin = isVerySmallScreen
    ? 12
    : isSmallScreen
    ? 16
    : isMediumScreen
  ...
  const safeBottomPadding = Math.max(
    insets.bottom + 220, // Much higher - 220px for bottom nav
    isVerySmallScreen ? 230 : isSmallScreen ? 240 : 250
  );

  // Generate dynamic styles
  const styles = getVoiceModalStyles(
    colors,
    insets,
    isSmallScreen,
    isVerySmallScreen
...
const getVoiceModalStyles = (
  ...
  StyleSheet.create({
    ...
    controlsContainer: {
      ...
      paddingBottom: spacing.xl, // Add some bottom padding
    },
    recordingControls: {
      alignItems: "center",
    ...
    playbackContainer: {
      ...
      paddingBottom: isVerySmallScreen
        ...
        : isSmallScreen
        ? spacing.md
        : spacing.xl, // Very compact for small screens
    },
    playbackControls: {
      flexDirection: "row",
      alignItems: "center",
    ...
    sendButton: {
      ...
      paddingHorizontal: isVerySmallScreen ? spacing.lg : spacing.xl,
      // marginTop: spacing.sm, // Reduced margins
      // marginBottom: 64, // Remove bottom margin to save space
      ...shadows.medium,
      // elevation: 4,
    },
    sendButtonDisabled: {
